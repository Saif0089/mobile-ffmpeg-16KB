Pod::Spec.new do |s|  
    ...
    s.description       = <<-DESC
    Includes FFmpeg v8.0 (Huffman) with fontconfig v2.13.92, freetype v2.10.2, fribidi v1.0.9, kvazaar v2.0.0, libaom v1.0.0-errata1-avif-110, libass v0.14.0, libtheora v1.1.1, libvpx v1.8.2, snappy v1.1.8 and libwebp v1.1.0 libraries enabled.
    DESC
